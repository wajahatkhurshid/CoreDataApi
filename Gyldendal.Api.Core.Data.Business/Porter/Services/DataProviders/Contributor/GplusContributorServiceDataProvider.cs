...
{
    public class GplusContributorServiceDataProvider : BaseContributorServiceDataProvider, IContributorServiceDataProvider
    {
        private readonly IContentfulManager _contentfulManager;

        private readonly ILogger _logger;

        public GplusContributorServiceDataProvider(IContentfulManager contentfulManager, ILogger logger)
        {
