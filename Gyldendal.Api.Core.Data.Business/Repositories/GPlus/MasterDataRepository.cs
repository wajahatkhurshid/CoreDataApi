...
namespace Gyldendal.Api.CoreData.Business.Repositories.GPlus
{
    public class MasterDataRepository : BaseRepository, IMasterDataRepository
    {
        ...
        /// <summary>
        /// Get Media Types of GPlus Shop from KD
        /// </summary>
        /// <returns></returns>
        public IEnumerable<MediaType> GetMediaTypes()
        {
            var mediaTypes = KdEntities.DEA_KDWS_GPlusmedietype
        ...
        /// <summary>
        /// Get Areas of GPlus Shop from KD
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Area> GetAreas()
        {
            var areas = KdEntities.DEA_KDWS_GPluscategory
                        .Where(x => x.niveau == 1)
                        .Select(a => new Area
                        {
                            Id = a.id,
        ...
        /// <summary>
        /// Get Subjects of GPlus Shop from KD
        /// </summary>
        /// <param name="areaId"></param>
        /// <returns></returns>
        public IEnumerable<Subject> GetSubjects(int areaId)
        {
            var subjects = KdEntities.DEA_KDWS_GPluscategory
        ...
        {
            var subAreas =
                KdEntities.DEA_KDWS_GPluscategory
        ...
        /// <summary>
        /// Get Levels of GPlus Shop from KD
        /// </summary>
        /// <param name="areaId"></param>
        /// <returns></returns>
        public IEnumerable<Level> GetLevels(int areaId)
        {
            var kdLevels = KdEntities.DEA_KDWS_GPlus_LevelCategoriesView
        ...
        /// <summary>
        /// Gets Material Types of GPlus Shop from KD
        /// </summary>
        /// <returns></returns>
        public IEnumerable<MaterialType> GetMaterialTypes()
        {
            var materialTypes = KdEntities.DEA_KDWS_GPlusmaterialtype
