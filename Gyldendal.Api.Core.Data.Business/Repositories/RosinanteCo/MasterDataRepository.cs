...
namespace Gyldendal.Api.CoreData.Business.Repositories.RosinanteCo
{
    public class MasterDataRepository: BaseRepository, IMasterDataRepository
    {
        ...
        {
            var mediaTypes = KdEntities.DEA_KDWS_ROSCOmedietype
        ...
        {
            var areas = KdEntities.DEA_KDWS_ROSCOcategory
                                   .Where(x => x.niveau == 1)
                                   .Select(a => new Area
                                   {
                                       Id = a.id,
        ...
        {
            var subjects = KdEntities.DEA_KDWS_ROSCOcategory
        ...
        {
            var subAreas =
                           KdEntities.DEA_KDWS_ROSCOcategory
        ...
        {
            var materialTypes = KdEntities.DEA_KDWS_ROSCOmaterialtype
