...
namespace Gyldendal.Api.CoreData.Business.Repositories.Munks
{
    public class MasterDataRepository : BaseRepository, IMasterDataRepository
    {
        ...
        /// <summary>
        /// Get Media Types of Munk Shop from KD
        /// </summary>
        /// <returns></returns>
        public IEnumerable<MediaType> GetMediaTypes()
        {
            var mediaTypes = KdEntities.DEA_KDWS_MUNKmedietype
        ...
        /// <summary>
        /// Get Areas of Munk Shop from KD
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Area> GetAreas()
        {
            var areas = KdEntities.DEA_KDWS_MUNKcategory
                .Where(x => x.niveau == 4)
                .Select(a => new Area
                {
                    Id = a.id,
        ...
        /// <summary>
        /// Get Subjects of Munk Shop from KD
        /// </summary>
        /// <param name="areaId"></param>
        /// <returns></returns>
        public IEnumerable<Subject> GetSubjects(int areaId)
        {
            var subjects = KdEntities.DEA_KDWS_MUNKcategory
        ...
        {
            var subAreas =
                KdEntities.DEA_KDWS_MUNKcategory
        ...
        /// <summary>
        /// Get Levels of Munk Shop from KD
        /// </summary>
        /// <param name="areaId"></param>
        /// <returns></returns>
        public IEnumerable<Level> GetLevels(int areaId)
        {
            var kdLevels = KdEntities.DEA_KDWS_Munk_LevelCategoriesView
        ...
        /// <summary>
        /// Gets Material Types of Munk Shop from KD
        /// </summary>
        /// <returns></returns>
        public IEnumerable<MaterialType> GetMaterialTypes()
        {
            var materialTypes = KdEntities.DEA_KDWS_MUNKmaterialtype
