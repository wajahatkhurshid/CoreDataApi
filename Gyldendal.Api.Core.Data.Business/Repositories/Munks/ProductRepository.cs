...
namespace Gyldendal.Api.CoreData.Business.Repositories.Munks
{
    public class ProductRepository : BaseWorkProductRepository, IProductRepository
    {
        ...
        /// <summary>
        /// Constructor of Munk Product Repository
        /// </summary>
        ...
        /// <summary>
        /// Gets MunksGard Product Details by it's isbn from KD
        /// </summary>
        ...
        public Product GetProductByIsbn(string isbn)
        {
            ...
            var product = munkProduct.ToCoreDataProduct(_shopServicesApiClient, _imageUtil, _configurationManager, HasFreeSupplementaryMaterial(isbn));
        ...
        /// <summary>
        /// Get Munks Bundle details By isbn
        /// </summary>
        /// <param name="isbn"></param>
        /// <returns></returns>
        ...
        {
            return KdEntities.DEA_KDWS_MUNK_ConsolidatedProdLogView.Count(x => x.LastAction_TimeStamp > updatedAfter);
        }
        ...
        public IEnumerable<ProductUpdateInfo> GetProductsUpdateInfo(DateTime updatedAfter, int pageIndex, int pageSize)
        {
            ...
            return KdEntities.DEA_KDWS_MUNK_ConsolidatedProdLogView.Where(x => x.LastAction_TimeStamp > updatedAfter)
        ...
        public Result<string> GetBundleIdsByIsbn(string isbn, int pageIndex, int pageSize)
        {
            ...
            var bundleIds = KdEntities.DEA_KDWS_MUNKBundle_Products
        ...
        {
            return campaigns.Join(KdEntities.DEA_KDWS_MUNKproduct, cmp => cmp.MediaType, prod => prod.medietype,
        ...
        private IQueryable<string> GroupCampaignProds(IQueryable<Campaign> campaigns)
        {
            return campaigns.Join(KdEntities.CampaignItem, c => c.Id, ci => ci.CampaignId,
                (c, ci) => new { c, ci })
                .Join(KdEntities.DEA_KDWS_MUNKproduct, cmp => cmp.ci.VareId, prod => prod.vare_id,
                    (cmp, prod) => new { cmp, prod })
