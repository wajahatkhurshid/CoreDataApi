...
namespace Gyldendal.Api.CoreData.Business.Repositories.Munks
{
    public class WorkRepository : BaseWorkProductRepository, IWorkRepository
    {
        ...
        /// <summary>
        /// Constructor of Munk work Repository
        /// </summary>
        ...
        /// <summary>
        /// Return List of Deleted Works Ids of Munk shop from KD
        /// </summary>
        /// <returns></returns>
        public List<string> GetDeletedWorks(DateTime? fromDate)
        {
            ...
            return KdEntities.DEA_KDWS_MUNKWorkLog
        ...
        /// <summary>
        /// Returns work object with product details of munk webshop
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <returns></returns>
        private IEnumerable<DEA_KDWS_MUNKcategory> GetProductCategories(string isbn)
        {
            return
                (from prodCatView in KdEntities.DEA_KDWS_MUNK_ProductCategoriesView
                 join category in KdEntities.DEA_KDWS_MUNKcategory on prodCatView.kategori equals category.id
        ...
        {
            var munkProduct = KdEntities.DEA_KDWS_MUNKproduct
                .Include("DEA_KDWS_MUNKproductseries.DEA_KDWS_MUNKseries")
                .Include("DEA_KDWS_MUNKproductcontributors.DEA_KDWS_MUNKContributors")
                .Include("DEA_KDWS_MUNKProductCategories.DEA_KDWS_MUNKcategory")
                .Include("DEA_KDWS_MUNKProductLevels.DEA_KDWS_MUNKlevel")
                .Include("DEA_KDWS_MUNKwork")
                .FirstOrDefault(p => p.vare_id.Equals(isbn));

            if (munkProduct?.DEA_KDWS_MUNKwork == null)
            {
            ...
            var work = munkProduct.ToCoreDataWork(prodCategories.ToArray(), _shopServicesApiClient, _imageUtil, _configurationManager, HasFreeSupplementaryMaterial(isbn));
        ...
        {
            var kdBundleCategories = (from kdbundle in KdEntities.DEA_KDWS_MUNKBundle
                                      where kdbundle.bundle_id.Equals(id)
                                      let kdCategories = (from kdcategory in KdEntities.DEA_KDWS_MUNKcategory
                                                          join kdbundleCategory in KdEntities.DEA_KDWS_MUNK_BundleCategoriesView on kdcategory.id equals kdbundleCategory.kategori
