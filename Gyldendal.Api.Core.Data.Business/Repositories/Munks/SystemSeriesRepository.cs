...
namespace Gyldendal.Api.CoreData.Business.Repositories.Munks
{
    public class SystemSeriesRepository : BaseRepository, ISystemSeriesRepository
    {
        ...
        public SystemSeriesRepository(koncerndata_webshops_Entities kdEntities, IConfigurationManager configManager) :
            base(DataScope.MunksGaardShop, kdEntities)
        {
        ...
        /// <summary>
        /// Returns IQueryable of Munk series db objec, for the query type i.e. SeriesOnly, SystemOnly, or All.
        /// </summary>
        /// <returns></returns>
        private IQueryable<DEA_KDWS_MUNKseries> GetSystemSeriesQuery(GetSeriesRequestType queryType)
        {
            var seriesQuery =
                KdEntities.DEA_KDWS_MUNKseries

                .Include("DEA_KDWS_MUNKserieAreas")
                .Include("DEA_KDWS_MUNKserieSubjects")
                .Include("DEA_KDWS_MUNKserieSubAreas")
                .Include("DEA_KDWS_MUNKseriesLevel.DEA_KDWS_MUNKlevel")

                .Include("DEA_KDWS_MUNKseries2.DEA_KDWS_MUNKserieAreas")
                .Include("DEA_KDWS_MUNKseries2.DEA_KDWS_MUNKserieSubjects")
                .Include("DEA_KDWS_MUNKseries2.DEA_KDWS_MUNKserieSubAreas")
                .Include("DEA_KDWS_MUNKseries2.DEA_KDWS_MUNKseriesLevel.DEA_KDWS_MUNKlevel")

                .Include("DEA_KDWS_MUNKseries1.DEA_KDWS_MUNKserieAreas")
                .Include("DEA_KDWS_MUNKseries1.DEA_KDWS_MUNKserieSubjects")
                .Include("DEA_KDWS_MUNKseries1.DEA_KDWS_MUNKserieSubAreas")
                .Include("DEA_KDWS_MUNKseries1.DEA_KDWS_MUNKseriesLevel.DEA_KDWS_MUNKlevel")
        ...
        /// <returns></returns>
        private static IQueryable<DEA_KDWS_MUNKseries> ApplyFilters(IQueryable<DEA_KDWS_MUNKseries> seriesQuery, GetSeriesRequest request)
        {
            ...
            if (areaFilter)
            {
                seriesQuery = seriesQuery.Where(x => x.DEA_KDWS_MUNKserieAreas.Any(y => y.area == request.Area));
            }

            if (subjectFilter)
            {
                seriesQuery = seriesQuery.Where(x => x.DEA_KDWS_MUNKserieSubjects.Any(y => y.subject == request.Subject));
            }
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        private static IQueryable<DEA_KDWS_MUNKseries> ApplySorting(IQueryable<DEA_KDWS_MUNKseries> seriesQuery, GetSeriesRequest request)
        {
        ...
        /// <summary>
        /// Materializes the IQueryable of MUNK series db object into domain model's Series object.
        /// </summary>
        /// <param name="seriesQuery"></param>
        /// <returns></returns>
        private IEnumerable<Series> MaterializeSeriesQuery(IQueryable<DEA_KDWS_MUNKseries> seriesQuery)
        {
        ...
        /// <returns></returns>
        private Series ConstructSeries(DEA_KDWS_MUNKseries series, bool setParentAndChild = false)
        {
            var retVal = new Series
            {
                ...
                Areas = series.DEA_KDWS_MUNKserieAreas?.Select(x => new Area
                {
                    Id = x.AreaId,
                    Name = x.area,
                    WebShop = WebShop
                }).ToList(),
                Subjects = series.DEA_KDWS_MUNKserieSubjects?.Select(x => new Subject
                {
                    Id = x.SubjectId,
                    Name = x.subject,
                    WebShop = WebShop,
                ...
                SubAreas = series.DEA_KDWS_MUNKserieSubAreas?.Select(x => new SubArea
                {
                    Id = x.SubAreaId,
                    Name = x.subarea,
                    WebShop = WebShop,
                ...
                Levels = series.DEA_KDWS_MUNKseriesLevel?.Select(l => new Level
                {
                    WebShop = WebShop,
                    Name = l.DEA_KDWS_MUNKlevel.navn,
                    LevelNumber = l.DEA_KDWS_MUNKlevel.niveau,
                    AreaId = l.DEA_KDWS_MUNKlevel.kategori_id
                }).ToList(),
            ...
            if (setParentAndChild && series.DEA_KDWS_MUNKseries2 != null)
            {
                retVal.ParentSeries = ConstructSeries(series.DEA_KDWS_MUNKseries2);
            }

            if (setParentAndChild && (series.DEA_KDWS_MUNKseries1?.Any() ?? false))
            {
                retVal.ChildSeries = new List<Series>();
                foreach (var childSerie in series.DEA_KDWS_MUNKseries1)
                {
